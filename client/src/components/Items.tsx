...
export class Items extends React.PureComponent<ItemsProps, ItemsState> {
  ...
  renderCreateItemInput() {
    return (
      <div>
        ...
        <Divider horizontal><h2>Add New Event</h2></Divider>
  ...
  renderLoading() {
    return (
      ...
      <Grid.Row>
        <Divider horizontal><h3>Events List</h3></Divider>
  ...
  renderItemsList() {
    return (
      <Container>
        <Divider horizontal><h3>Your Events</h3></Divider>
